...
* On receiving the config it opens/creates a file (for each node) to write data into and name it after the entry on the .yml file for which it's performing the RPC to, and makes it a .txt on closing the file. 
